...
const TextEditor = ({onChange}: {onChange: (e: ChangeEvent<HTMLTextAreaElement>) => void}) => {
    return <form className="h-full my-3">
        <div className="flex flex-col w-full h-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
           ...
           <div className="flex flex-col flex-grow px-2 py-2 bg-white rounded-b-lg dark:bg-gray-800">
               <label  className="sr-only">Publish post</label>
               <textarea onChange={onChange} id="editor" className=" px-3 p-3 flex-grow min-h-full block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 hover:outline focus:outline-none focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
           </div>
       </div>
    </form>
